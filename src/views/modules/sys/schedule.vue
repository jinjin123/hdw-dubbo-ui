  ...
  <div class="mod-schedule">
    ...
    <el-table
      ...
      <el-table-column
        ...
        label="操作">
        <template slot-scope="scope">
          <el-button v-if="isAuth('sys/schedule/update')" type="text" size="small" @click="addOrUpdateHandle(scope.row.jobId)"><i class="el-icon-edit"></i></el-button>
          <el-button v-if="isAuth('sys/schedule/delete')" type="text" size="small" @click="deleteHandle(scope.row.jobId)"><i class="el-icon-delete"></i></el-button>
